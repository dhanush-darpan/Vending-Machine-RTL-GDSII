...
# Generated on: Tue Sep 23 16:12:19 IST 2025 (Tue Sep 23 10:42:19 UTC 2025)
...
set_log_file fv/vendingMachine_1/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/vendingMachine_1 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  vendingMachine.v
elaborate_design -golden -root {vendingMachine} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/vendingMachine_1/fv_map.v.gz
elaborate_design -revised -root {vendingMachine_1}
...
#add_name_alias fv/vendingMachine_1/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/vendingMachine_1/rtl_to_fv_map.log
}
