...
# Generated on: Tue Sep 23 16:16:51 IST 2025 (Tue Sep 23 10:46:51 UTC 2025)
...
set_log_file fv/vendingMachine/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/vendingMachine -revised fv_map
...
read_design -verilog95   -revised -lastmod -noelab fv/vendingMachine/fv_map.v.gz
elaborate_design -revised -root {vendingMachine}
...
#add_name_alias fv/vendingMachine/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/vendingMachine/rtl_to_fv_map.log
}
